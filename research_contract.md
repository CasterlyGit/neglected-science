...
1. Every consequential factual claim must identify its source and precise source location.
2. AI-generated summaries are unverified until checked against the source.
3. Secondary sources may orient retrieval but do not replace primary evidence for scientific claims.
4. Missing, inaccessible, retracted, corrected, or disputed evidence must remain visible.
5. The corpus must have documented inclusion, exclusion, coverage, and stopping rules.

## Reasoning

6. Records must distinguish observation, statistical relationship, model inference, causal hypothesis, and speculation.
7. Every promoted question must include competing explanations and evidence against novelty.
