...
def evaluate():
    ...
    return {
        ...
        "quality_verdict": "leniency-audit-required" if pass_rate > 0.9 else "within-target" if pass_rate >= 0.8 else "process-improvement-required",
        ...
        "next_permitted_action": "Run a source-level leniency audit on a predeclared subset; do not promote the two provisional records or start System-2 selection.",
    }
