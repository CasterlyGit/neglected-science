...
- Canonical local repository created.
- Local project identity and delivery policy declared.
- Governing vision and nine-milestone roadmap recorded.
- Milestone 1 completed with a research contract, gap taxonomy, scoring protocol, novelty challenge, machine-readable dossier schema, and contract tests.
- Milestone 2 completed with a selected bounded territory, alternative comparison, explicit corpus/compute limits, and stop/reopen rules.
- Milestone 3 completed with 56 sources, 65 source-linked claims, Crossref title verification for all 48 papers, a stratified source review, corrected extraction sampling, and two saturation passes per domain.
...
- `reports/milestone-6-novelty.md`
