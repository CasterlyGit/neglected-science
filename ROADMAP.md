# Nine-milestone roadmap

Status values are `not-started`, `active`, `complete`, or `gated`. Completion means the stated evidence exists; scaffolding alone does not count.

## 1. Establish the research constitution — complete

Define the research contract, gap taxonomy, opportunity scoring method, novelty-challenge protocol, provenance rules, and machine-readable dossier contract.

Completion gate: all governing documents agree; the dossier schema validates representative valid and invalid examples; no unresolved policy contradiction remains.

## 2. Select a bounded discovery territory — complete

Evaluate and document a coherent first territory narrow enough for rigorous retrieval yet broad enough to reveal cross-disciplinary translation gaps.
...
### E.5 Certify execution readiness — required before future Milestone 7 selection
