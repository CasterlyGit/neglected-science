...
Neglected Science is a scientific metaresearch and validation program. Treat `VISION.md`, `research_contract.md`, and `ROADMAP.md` as governing documents.

- Do not equate a literature gap with scientific novelty.
